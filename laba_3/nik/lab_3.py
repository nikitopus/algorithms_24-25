...
def hash_md5(source_file, salt):
    with open("new_hashes_md5.txt", "w", encoding="utf-8") as md5:
...
if __name__ == "__main__":
    ...
    # hash_md5(source_file, salt)
    # hash_sha1(source_file, salt)
    # hash_sha256(source_file, salt)

    # time_md5 = dehashing("output_md5.txt", "new_hashes_md5.txt")
    # print("done_md5")
